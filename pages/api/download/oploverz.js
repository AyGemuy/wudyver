...
class Oploverz {
  ...
  async gen(url, option = null) {
    try {
      ...
      return { generatedLink: match[1], option };
    } catch (error) {
  ...
  try {
    switch (action) {
      ...
      case "ongoing":
        ...
        return res.status(200).json({ success: true, results: ongoingResults });
        
        case "complete":
        const completeResults = await oploverz.complete();
        return res.status(200).json({ success: true, results: completeResults });
        ...
        return res.status(200).json({ success: true, results: episodeResults });
        
        case "random":
        const randomResults = await oploverz.random();
        return res.status(200).json({ success: true, results: randomResults });
      ...
      case "download":
        ...
        return res.status(200).json({ success: true, results: downloadResults });
        ...
        return res.status(200).json({ success: true, results: genResults });
