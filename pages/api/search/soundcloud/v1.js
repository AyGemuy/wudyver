...
class SoundCloud {
    constructor() {
        ...
        this.baseHtmlUrl = `https://${process.env.DOMAIN_URL}/api/tools/web/html/v2?url=`;
    }
    ...
    async detail(url) {
        ...
        const jsonData = scriptTag ? JSON.parse(scriptTag).props.pageProps.initialStoreState.entities.tracks : {};
