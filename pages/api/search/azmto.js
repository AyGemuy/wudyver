...
async function searchAzm(query) {
  ...
  try {
    ...
    return $(".col-3.col-tb-4.col-p-6.col-md-2.poster-col")
      .map((index, element) => {
...
async function detailAzm(query) {
  ...
  try {
    ...
    details.breadcrumbs = $(".container.row.details .col-12.breadcrumbs.has-icon a")
    ...
    details.genres = $(".container.row.details .col-6.col-md-7.mb-2.col-tl-9.col-tb-12.details__info .details__genre a")
      .map((_, el) => $(el).text().trim())
      .get();
    details.overview = $(".container.row.details .col-6.col-md-7.mb-2.col-tl-9.col-tb-12.details__info .details__overview").text().trim();
    details.serverLinks = $(".container.row.details .col-12.m-children-bottom-1.flex.flex-between.col-12.mt-1.player__server-wrapper .details__genre a")
      .map((_, el) => ({
        link: $(el).attr("value"),
