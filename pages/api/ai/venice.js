...
class VeniceAPI {
  ...
  async uploadImage(buffer) {
    try {
      ...
      if (!uploadResponse) {
        throw new Error("Proses unggah gagal atau URL tidak ditemukan dalam respons.");
      }
      return uploadResponse;
    } catch (error) {
      console.error("Gagal mengunggah ke Supa:", error.response?.data || error.message);
      throw new Error("Gagal saat proses unggah gambar.");
    }
  }
  async image(rest = {}) {
    try {
