...
class BuzzFun {
  ...
  async generate({
    ...
    try {
      ...
      const response = await axios.get(`https://buzzfun.me/en/quizzes/details/id/${id}/type/image_lab_new.html`, {
        headers: {
          ...this.headers,
      ...
      const uploadResponse = await axios.post("https://buzzfun.me/en/upload", postData, {
        headers: {
          ...this.headers,
          cookie: this.cookie
        }
      ...
      const resultResponse = await axios.post("https://buzzfun.me/en/result/getResult", resultPostData, {
        headers: {
          ...this.headers,
          cookie: this.cookie
        }
      ...
      while (true) {
        const taskResponse = await axios.post("https://buzzfun.me/en/task-manager/result", taskManagerPostData, {
          headers: {
            ...this.headers,
            cookie: this.cookie
          }
