...
export default async function handler(req, res) {
  ...
  const { prompt, model = "aichat" } = req.query;
  ...
  const supportedModels = [
    "CgtAi", "GoodyAI", "LetmeGpt", "Simsimi", "alicia", "cairo",
    "degreeguru", "leptonAi", "omniplexAi", "ragbot", "stoicai",
    "stoicgpt", "thinkany", "useadrenaline", "aichat",
  ];
