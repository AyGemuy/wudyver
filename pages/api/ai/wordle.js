...
export default async function handler(req, res) {
    ...
    const { prompt, assistant = "Kamu adalah asisten AI yang siap membantu segala hal!" } = req.query;
    ...
    try {
        ...
        return res.status(200).json({ message: result.messages?.[1]?.content || "No response received" });
    } catch (error) {
