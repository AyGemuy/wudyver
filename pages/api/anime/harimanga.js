  ...
  try {
    switch (action) {
      case 'latest':
        ...
        return res.status(200).json({ success: true, data: latestResults });
      ...
      case 'detail':
        ...
        return res.status(200).json({ success: true, data: detailResults });
      ...
      case 'chapters':
        ...
        return res.status(200).json({ success: true, data: chaptersResults });
