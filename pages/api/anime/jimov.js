...
export default async function handler(req, res) {
  ...
  const getUrl = (provider, action, params) => {
    switch (provider) {
      case 'animeflv':
        return action === 'filter' ? `${baseURL}/anime/animeflv/filter?${new URLSearchParams(params)}` :
               action === 'name' ? `${baseURL}/anime/animeflv/name/${encodeURIComponent(params.name)}` :
               action === 'episode' ? `${baseURL}/anime/animeflv/episode/${encodeURIComponent(params.episode)}` : '';
      case 'animelatinohd':
        return action === 'filter' ? `${baseURL}/anime/animelatinohd/filter?${new URLSearchParams(params)}` :
               action === 'name' ? `${baseURL}/anime/animelatinohd/name/${encodeURIComponent(params.name)}` :
               action === 'episode' ? `${baseURL}/anime/animelatinohd/episode/${encodeURIComponent(params.episode)}` : '';
      case 'monoschinos':
        return action === 'filter' ? `${baseURL}/anime/monoschinos/filter?${new URLSearchParams(params)}` :
      ...
      case 'inmanga':
        return action === 'filter' ? `${baseURL}/manga/inmanga/filter?${new URLSearchParams(params)}` :
      ...
      case 'mangareader':
        return action === 'filter' ? `${baseURL}/manga/mangareader/filter?${new URLSearchParams(params)}` :
      ...
      case 'manganelo':
        return action === 'filter' ? `${baseURL}/manga/manganelo/filter?${new URLSearchParams(params)}` :
      ...
      case 'tioanime':
        return action === 'filter' ? `${baseURL}/anime/tioanime/filter?${new URLSearchParams(params)}` :
