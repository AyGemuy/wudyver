...
class SpaceAPI {
  ...
  async getSpaceData() {
    try {
      ...
      const { latitude, longitude } = issLocationResponse.data.iss_position || { latitude: 'N/A', longitude: 'N/A' };
      const issTimestamp = new Date(issLocationResponse.data.timestamp * 1000).toISOString() || 'N/A';
