...
export default async function handler(req, res) {
  if (req.method === 'GET') {
    const { background = 'https://png.pngtree.com/thumb_back/fw800/background/20240911/pngtree-surreal-moonlit-panorama-pc-wallpaper-image_16148136.jpg', borderColor = '#f0f0f0', overlayOpacity = 0.7, keyLength = 15 } = req.query;
