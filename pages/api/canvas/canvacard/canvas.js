...
export default async function handler(req, res) {
  ...
  const { image = 'https://png.pngtree.com/thumb_back/fw800/background/20230117/pngtree-girl-with-red-eyes-in-anime-style-backdrop-poster-head-photo-image_49274352.jpg', effect = 'jail', ...params } = req.query;
  ...
  case "gradient":
    ...
    break;
  case "quote":
    imageBuffer = await Canvas.quote({ text: params.text, author: params.author }, params.font || "Arial");
    break;
  case "phub":
    imageBuffer = await Canvas.phub({ text: params.text }, params.font || "Arial");
    break;
  case "wanted":
  ...
  case "wasted":
    ...
    break;
  case "youtube":
    imageBuffer = await Canvas.youtube({ username: params.username, content: params.content, avatar: params.avatar, dark: params.dark || false });
    break;
  case "reply":
