...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        body { display: flex; justify-content: center; align-items: center; height: 100vh; width: 100vw; background: transparent; }
        .chat-box { display: flex; flex-direction: column; gap: 20px; }
        .chat-container { display: flex; align-items: flex-start; gap: 20px; }
        .chat-container img { width: 100px; height: 100px; border-radius: 50%; }
        ...
        .reply-media img { width: 120px; height: 120px; border-radius: 10px; margin-top: 10px; }
        .media img { width: 100%; border-radius: 20px; margin-top: 12px; }
    </style>
</head>
<body>
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        .chat-container img { width: 80px; height: 80px; border-radius: 50%; }
        .chat-bubble { 
            position: relative; 
            background: white; 
            color: black; 
        ...
        .reply-media img { width: 150px; height: 150px; border-radius: 15px; margin-top: 15px; }
        .media img { width: 100%; border-radius: 20px; margin-top: 15px; }
    </style>
</head>
<body>
