...
export const DashboardMenu = [
	...
	},
	{
		...
		children: [
			...
			{ id: uuid(), link: '/pages/alquran', name: 'Alquran' },
  { id: uuid(), link: '/pages/compiler', name: 'Compiler' },
  { id: uuid(), link: '/pages/html-preview', name: 'HTML Preview' },
  { id: uuid(), link: '/pages/playwright', name: 'Playwright' },
  { id: uuid(), link: '/pages/quotes', name: 'Quotes' },
  { id: uuid(), link: '/pages/settings', name: 'Settings' },
  { id: uuid(), link: '/pages/api-demo', name: 'API Demo' },
  { id: uuid(), link: '/pages/cuaca', name: 'Cuaca' },
  { id: uuid(), link: '/pages/mikasa', name: 'Mikasa' },
  { id: uuid(), link: '/pages/pricing', name: 'Pricing' },
  { id: uuid(), link: '/pages/room-chat', name: 'Room Chat' },
  { id: uuid(), link: '/pages/anonymous', name: 'Anonymous Chat' },
  { id: uuid(), link: '/pages/shortlink', name: 'Shortlink' },
  { id: uuid(), link: '/pages/billing', name: 'Billing' },
  { id: uuid(), link: '/pages/hentai', name: 'Hentai' },
  { id: uuid(), link: '/pages/pairing', name: 'Pairing' },
  { id: uuid(), link: '/pages/profile', name: 'Profile' },
  { id: uuid(), link: '/pages/savetik', name: 'Savetik' },
  { id: uuid(), link: '/pages/upload', name: 'Upload' },
  { id: uuid(), link: '/not-found', name: '404 Error' } // Halaman 404 Error
]
	},	
	{
		id: uuid(),
		...
		children: [
			...
			{ id: uuid(), link: '/authentication/sign-out', name: 'Sign Out' },
			{ id: uuid(), link: '/authentication/forget-password', name: 'Forget Password'},
			{ id: uuid(), link: '/authentication/reset-password', name: 'Reset Password'}			
		]
	},
	{
		id: uuid(),
