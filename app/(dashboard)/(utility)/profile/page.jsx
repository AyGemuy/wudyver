...
const ProfilePage = () => {
    ...
    const fetchSystemData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          "https://wudysoft.xyz/api/general/system-stats"
        );
        const data = response.data; // Axios puts the response data in the 'data' property
        ...
        // Axios errors have a 'response' property for server errors and 'message' for network errors
        setSystemStatsError(
  ...
  const infoItems = [
    ...
    },
    {
      ...
      label: "WEBSITE",
      value: process.env.NEXT_PUBLIC_DOMAIN_URL?.replace(/^https?:\/\//, ""),
