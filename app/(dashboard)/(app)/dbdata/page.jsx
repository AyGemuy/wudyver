      ...
      >
        <div className="p-4 sm:p-6 border-b border-slate-200 dark:border-slate-700/60">
          <div className="flex flex-col sm:flex-row items-center justify-between">
            ...
            <div className="w-full sm:w-auto sm:max-w-sm md:max-w-md relative">
                <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                  <Icon icon="ph:magnifying-glass-duotone" className="text-slate-400 dark:text-slate-500 text-base sm:text-lg" />
                </div>
                <input
                  type="text"
                  placeholder="Cari folder atau konten..."
                  className="w-full pl-10 pr-3 py-2 sm:py-2.5 text-sm sm:text-base bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-slate-200 rounded-md shadow-sm focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none transition-shadow"
                  value={searchTerm}
        ...
        {!loading && !error && filteredFolders.length > 0 && (
          <SimpleBar className="max-h-[calc(100vh-220px)]">
