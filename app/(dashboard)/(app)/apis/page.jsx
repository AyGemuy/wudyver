      ...
      >
        <div className="p-4 sm:p-6 border-b border-slate-200 dark:border-slate-700/60">
            <div className="flex flex-col sm:flex-row items-center">
                <div className="w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 text-white shadow-md mr-0 sm:mr-3 mb-2 sm:mb-0 shrink-0">
                    <Icon icon="ph:circuitry-duotone" className="text-2xl sm:text-3xl" />
                </div>
                <h1 className="text-xl md:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 to-teal-500 text-center sm:text-left">
                    Manajer OpenAPI & Playground
                </h1>
            </div>
        </div>
        ...
        <SimpleBar className="h-full" style={{ maxHeight: 'calc(100vh - 160px)' }}>
            <div className="p-4 sm:p-6">
                {status === "loading" && ( <div className="flex flex-col items-center justify-center p-10 min-h-[calc(100vh-260px)]"><Icon icon="svg-spinners:blocks-shuffle-3" className="text-5xl sm:text-6xl text-emerald-500 mb-4" /><p className="text-lg sm:text-xl font-medium text-slate-600 dark:text-slate-300">Memuat Spesifikasi...</p></div>)}
                {status === "failed" && (
