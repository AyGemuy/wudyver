...
const menuItems = [
    ...
    { name: "Stoplight", path: "/stoplight" },
    { name: "Docs", path: "/docs" },
    { name: "Stats", path: "/pages/stats" },
    { name: "Mikasa", path: "/pages/mikasa" },
  ];
const Docs = () => {
  return (
    <Container fluid className="p-6">
      ...
      <Row>
        ...
        <Card>
            <Card.Body>
              <h3 className="fw-bold">Documentation Menu</h3>
              <ul className="list-unstyled">
                {menuItems.map((item, idx) => (
                  <li key={idx} className="mb-3">
                    ...
                    <p>
                      Here is an API demo using fetch. <Link href={item.path}><code>click here</code></Link>
                    </p>
                  </li>
                ))}
              </ul>
