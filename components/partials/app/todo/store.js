...
// Async thunk untuk fetch dari API
export const fetchTodosFromRoutes = createAsyncThunk(
  "apptodo/fetchTodosFromRoutes",
  async () => {
...
export const appTodoSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchTodosFromRoutes.pending, (state) => {
